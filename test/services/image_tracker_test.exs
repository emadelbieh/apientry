defmodule Apientry.ImageTrackerTest do
  ...
  @product %{"categories" => %{"category" => [%{"items" => %{"item" => [
              %{"product" => %{"images" => %{"image" => [%{"sourceURL" => "http://google.com"}, %{"sourceURL" => "http://yahoo.com"}]}}},
              %{"product" => %{"images" => %{"image" => [%{"sourceURL" => "http://google.com"}, %{"sourceURL" => "http://yahoo.com"}]}}}]}}]}}

  @offer %{"categories" => %{"category" => [%{"items" => %{"item" => [
  ...
  test "get_image_urls extracts image urls from body with products" do
    urls = ImageTracker.get_image_urls(@product)
    assert urls == ["http://google.com", "http://yahoo.com", "http://google.com", "http://yahoo.com"]
  end

  test "get_image_urls extracts image urls from body with offers" do
    urls = ImageTracker.get_image_urls(@offer)
    assert urls == ["http://google.com", "http://yahoo.com", "http://google.com", "http://yahoo.com"]
  end
